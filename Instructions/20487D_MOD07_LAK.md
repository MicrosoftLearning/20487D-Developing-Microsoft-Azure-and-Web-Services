...
x. In the **Location** list, select a region you can provision to.
x. For **Performance**, leave the setting as **Standard**.
...
x. Click **Review + create**.
8. Once validation has succeeded, click **Create**.
