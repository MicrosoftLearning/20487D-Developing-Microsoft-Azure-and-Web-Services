...
3.  In **DbInitializer.cs**, add the following code:
   ...
   ```
4. In **VS Code**, click **File** and then click **Save**.
...
12. Locate the **Main** method, and then replace the content with the following code:
   ...
   ```
12. In **VS Code**, click **File** and then click **Save**.
...
5. On the **Explorer** blade, under **STARTER**, expand the **DAL** folder, expand the **Repository** folder, and then double-click **HotelBookingRepository.cs**.
6. To add a private field for **DbContextOptions**, inside Class, paste the following code:
   ```cs
    private DbContextOptions<MyDbContext> _options;
   ```
7. To add a new constructor that initializes the **options**, inside Class, paste the following code:
   ```cs
   ...
   ``` 
8. To add a new constructor with **options** parameter, inside Class, paste the following code:
   ```cs
   ...
   ```
9. To add a new booking entity to **Database**, inside Class, paste the following code:
   ```cs
...
1. To update the booking entity in **Database**, inside Class, paste the following code:
   ```cs
...
1. To delete the booking entity from **Database**, inside Class, paste the following code:
   ```cs
   ...
   ```
2. In **VS Code**, click **File** and then click **Save**.
3. Close **VS Code**.
...
5. To return to the solution folder, run the following command:
   ...
   cd ..
   ```
6. If required, open the solution in VS Code, paste the following command:
   ```bash
    code .
   ```
   ...
   ```cs
     private DbContextOptions<MyDbContext> _options =
               new DbContextOptionsBuilder<MyDbContext>()
                   ...
                   .Options;
   ```
9. To test bookings in **SQLite**, within the Class, paste the following method:
   ```cs
     [TestMethod]
