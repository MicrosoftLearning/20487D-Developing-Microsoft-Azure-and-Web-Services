...
6. To add a private field for **DbContextOptions**, inside Class paste the following code:
   ...
   ```
7. To add a new constructor that initialize the **options**, inside Class paste the following code:
   ```cs
...
8. To add a new constructor with **options** parameter, inside Class paste the following code:
   ...
   ```
9. To add a new booking entity to **Database**, inside **Class**, paste the following method:
   ```cs
...
5. In the **Server** box, type **.\SQLEXPRESS**, and then click **Connect**.
6. On the **Servers** blade, expand **.\sqlexpress**, and then expand **Databases**.
