...
3. To create a new **ExecutionTimeMiddleware** class, right-click the **Middleware** folder, select **New Flie**, and then name it **ExecutionTimeMiddleware.cs**.
4. To the **ExecutionTimeMiddleware** class, add the following **using** statements:
   ```cs
...
6. To add a class declaration, inside the **namespace** brackets, enter the following code:
    ...
    ```
7. To add the **AddResponseHeaders** method, inside the **class** brackets, enter the following code:
    ```cs
...
2. Open Microsoft Edge and go to the following URL.
    ...
    ```
3. In the title bar, click **Settings and more**, and then select **Developer Tools**.
