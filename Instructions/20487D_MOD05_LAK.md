...
5. Run the following command:
    ...
    .\createAzureSQL.ps1
    ```
    > **Note**: If you get an error saying that PowerShell files is not digitally signed, Run the following command: **Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass**
...
7. Wait until the deployment is complete before proceeding to the next step. You should see:
    ```
...
9. In the **Docker** notification, click **Share It**.
    ...
    >**Note**: This will take 5-15 minutes. <br /><br />
