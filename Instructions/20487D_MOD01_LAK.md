...
6. To create the **WebApp**, enter the following fields:
   ...
   >**Note**: The **App Name** will be part of the URL.
    ...
    - Click **Create**.
    - Your Deployment will begin and will take 2-3 minutes to compplete.
